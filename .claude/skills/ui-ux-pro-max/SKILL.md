...
The search script lives inside this skill's own directory, not the project directory. Invoke it from the project root using the path below (or the absolute equivalent) — do not assume any other working directory:
